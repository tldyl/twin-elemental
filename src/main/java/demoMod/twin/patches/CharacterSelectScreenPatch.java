...
public class CharacterSelectScreenPatch {
    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString(TwinElementalMod.makeID("Reskin"));
    ...
    public static class PatchRender {
        public static void Postfix(CharacterSelectScreen screen, SpriteBatch sb) {
            for (CharacterOption o : screen.options) {
                ...
                if (o.name.equals(ZetsuEnnNoTwins.NAME) && o.selected) {
            ...
            for (CharacterOption o : screen.options) {
                ...
                if (o.name.equals(ZetsuEnnNoTwins.NAME) && o.selected) {
                    ...
                    if (reskinRight.clicked || CInputActionSet.pageRightViewExhaust.isJustPressed()) {
                        ...
                        TwinElementalMod.saveData.setInt("reskinIndex", reskinIndex);
                    }

                    if (reskinLeft.clicked || CInputActionSet.pageLeftViewDeck.isJustPressed()) {
                    ...
                    if (reskinIndex != indexBefore) {
                        try {
                            TwinElementalMod.saveData.save();
                        } catch (IOException e) {
