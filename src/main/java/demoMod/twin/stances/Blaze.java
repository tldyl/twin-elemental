...
public class Blaze extends AbstractStance {
    ...
    public void onEnterStance() {
        ...
        if (p instanceof ZetsuEnnNoTwins) {
            AbstractDungeon.actionManager.addToBottom(new ChangeAnimationAction("ice_change_fire"));
            AbstractDungeon.actionManager.addToBottom(new ChangeAnimationAction("fire_on_idle"));
        }
